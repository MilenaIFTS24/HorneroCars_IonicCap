...
@Component({
  ...
  standalone: true,
  imports: [IonBadge, IonInfiniteScroll, IonInfiniteScrollContent, IonIcon, IonFooter, IonText, IonCardContent, IonButton, IonCardSubtitle, IonCardTitle, IonCardHeader, IonCard, IonBackButton, IonButtons, IonContent, IonHeader, IonTitle, IonToolbar, CommonModule, FormsModule]
})
