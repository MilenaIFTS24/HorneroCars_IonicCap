...
export class ReservarService {
  ...
  constructor() {
    this.cargarReservas(); // se ejecuta al iniciar el servicio
  }
  private async cargarReservas() {
    const respuesta = await Preferences.get({ key: this.storageKey });
    this.reservas = respuesta.value ? JSON.parse(respuesta.value) : [];
  }
